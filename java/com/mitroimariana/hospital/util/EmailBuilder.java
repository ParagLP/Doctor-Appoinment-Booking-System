package com.mitroimariana.hospital.util;
...
public class EmailBuilder {
	...
	public static String getUserRegistrationMessage(HashMap<String, String> map) {
		...
		msg.append("Registration is successful for Hospital Management System");
		msg.append("<H1>Hi! Greetings from Hospital Management!</H1>");
		msg.append(
				"<P>Congratulations for registering on HMS! You can now access your HMS account online - anywhere, anytime and  enjoy the flexibility to check the Hospital Services.</P>");
