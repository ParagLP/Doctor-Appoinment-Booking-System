...
import com.mitroimariana.hospital.form.ForgetPasswordForm;
import com.mitroimariana.hospital.form.LoginForm;
import com.mitroimariana.hospital.form.UserRegistrationForm;
...
public class LoginCtl extends BaseCtl {
	...
	public String submit(Locale locale, @ModelAttribute("form") @Valid UserRegistrationForm form,
		...
		if (OP_SAVE.equalsIgnoreCase(form.getOperation())) {
			...
			dto.setRoleId(RoleDTO.RECEPTIONIST);
